...
document.write(`<h1><b> Mark Sheet <b></h1>
                <i>English:</i> ${english} <br><br>
                <i>Urdu:</i> ${urdu} <br><br>
                <i>Math:</i> ${math} <br><br>
                <i>Computer:</i> ${computer} <br><br>
                <i>Total Marks Obtain:</i> ${maxTotmarks} / ${totmarksobt} <br><br>
                <i>Percentage:</i> ${percentage}% <br><br>
                <i>Grade:</i> ${grade} <br><br>`);


// MOBILE BRAND QUESTION
...
function searchMobile() {
  ...
  const output = document.getElementById('output'); // This now matches the HTML
